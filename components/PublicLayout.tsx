...
export const PublicLayout: React.FC<PublicLayoutProps> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-[#f8f9fa] font-sans selection:bg-red-100 selection:text-red-600 overflow-x-hidden">
      ...
      <main className="pt-4 lg:pt-10 min-h-[60vh]">
        {children}
      </main>

      <footer className="bg-white border-t border-slate-100 py-3 px-[5%] flex flex-col items-center">
        ...
        <div className="flex flex-wrap justify-center gap-x-2 gap-y-2 mb-2">
        ...
        <div className="w-full max-w-4xl pt-2 border-t border-slate-50 text-center">

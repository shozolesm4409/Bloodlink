...
import { subscribeToNotices, getUsers, ADMIN_EMAIL, subscribeToBloodRequests } from '../../services/api';
import { Notice, User, UserRole, NoticeType, BloodRequest } from '../../types';
import { Bell, ShieldCheck, User as UserIcon, Droplet } from 'lucide-react';
...
export const UserNotifications = () => {
  ...
  const allNotifications = [...relevantNotices, ...relevantBloodRequests]
  ...
  return (
    <div className="w-full max-w-4xl mx-auto pb-20 animate-in slide-in-from-bottom-4 duration-500">
                      ...
                      <div className="flex items-center gap-2 mb-1 flex-wrap">
                        <span className="font-bold text-sm text-slate-900 dark:text-white flex items-center gap-1">
                          ...
                          {author?.role === UserRole.SUPERADMIN ? (
                             ...
                             <ShieldCheck size={14} className={colorMap[author.approvedBadge] || 'text-slate-400'} />
                          ) : null}
                        </span>

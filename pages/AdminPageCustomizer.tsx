...
import { Monitor, Save, Globe, LogIn, UserPlus, BarChart, MessageSquare, Megaphone, Key, ShieldCheck, Database, Lock, Eye, Share2, UserCheck, Mail, Send, History, Type, Sparkles, X } from 'lucide-react';
import clsx from 'clsx';

const SectionCard = ({ title, icon: Icon, iconColor, children }: any) => (
  <Card className="p-8 space-y-6 rounded-[2.5rem] border-0 shadow-xl bg-white relative overflow-hidden group transition-shadow hover:shadow-2xl">
    ...
    <div className="flex items-center gap-4 mb-2">
      ...
      <h3 className="font-black text-xl text-slate-900 tracking-tight uppercase leading-none">{title}</h3>
    </div>
...
export const AdminPageCustomizer = () => {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500 pb-20 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 gap-8 px-4 lg:px-0">
        {activeTab === 'landing' && (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
            ...
            <div className="space-y-8">
              ...
              <SectionCard title="Landing Subtitle" icon={Type} iconColor="text-indigo-600">
                 <TextArea label="CTA Subtitle" value={config.ctaSubtitle} onChange={e => updateField('ctaSubtitle', e.target.value)} />
              </SectionCard>

              <SectionCard title="Global Footer Signature" icon={Sparkles} iconColor="text-slate-600">

        ...
        <div className="max-w-4xl mx-auto px-5 py-20 md:py-28">
          ...
          <div className="mb-12 text-center space-y-6">
             ...
             <div className="relative max-w-lg mx-auto group">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                  <Search className="h-5 w-5 text-indigo-400 dark:text-indigo-500 group-focus-within:text-indigo-600 transition-colors" />
                </div>
                <input
                  type="text"
                  className="block w-full pl-11 pr-4 py-4 bg-white dark:bg-slate-900 border border-indigo-100 dark:border-slate-800 rounded-2xl leading-5 placeholder-gray-400 dark:placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-base shadow-lg shadow-indigo-100/50 dark:shadow-none transition-all font-medium text-slate-900 dark:text-white"
          ...
          {loading ? (
            <div className="flex flex-col items-center justify-center py-20 opacity-60">
              ...
              <p className="font-bold text-indigo-500 dark:text-indigo-400 uppercase tracking-widest text-xs">Loading Knowledge Base...</p>
            </div>
            ...
            <div className="space-y-6">
              {filteredFaqs.map((faq, index) => (
                <div 
                  key={faq.id} 
                  className={clsx(
                    "faq-item accordion-item bg-white dark:bg-slate-900 rounded-2xl border border-gray-200/80 dark:border-slate-800 shadow-xl overflow-hidden transition-colors",
            ...
            <div className="text-center py-24 bg-white/60 dark:bg-slate-900/60 rounded-[2rem] border-2 border-dashed border-indigo-200/50 dark:border-slate-800 backdrop-blur-sm transition-colors">
              <p className="text-indigo-400 dark:text-indigo-500 font-bold italic text-lg">কোনো ফলাফল পাওয়া যায়নি।</p>
            </div>
          )}

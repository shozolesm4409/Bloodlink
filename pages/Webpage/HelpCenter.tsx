        ...
        <div className="flex bg-slate-100 dark:bg-slate-800 p-1.5 rounded-2xl mb-8 overflow-x-auto transition-colors">
          ...
          {!isAuthenticated && (
            <button 
              ...
              className={clsx("flex-1 py-3 rounded-xl text-xs font-black uppercase tracking-widest transition-all", activeTab === 'search' ? "bg-white dark:bg-slate-700 shadow text-red-600 dark:text-red-400" : "text-slate-500 dark:text-slate-400")}
            >
              Check Status
            </button>
          )}
        ...
        {activeTab === 'new' && (
          submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-6 relative z-10 animate-in fade-in slide-in-from-bottom-4">
              ...
              <Button type="submit" isLoading={loading} className="w-full py-4 rounded-xl text-base shadow-xl shadow-red-100 dark:shadow-red-900/20">
          ...
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4">
            <form onSubmit={handleSearch} className="relative">
               <Input 
                 ...
                 className="pl-12 py-4 rounded-2xl border-2 border-slate-100 dark:border-slate-800 focus:border-red-100 dark:focus:border-red-900 transition-colors"
               />
               <Search className="absolute left-4 top-4 text-slate-300 dark:text-slate-600" size={20} />
            ...
            {searchResults && (
              <div className="pt-6 border-t border-slate-100 dark:border-slate-800 transition-colors">
                <h3 className="text-sm font-black uppercase tracking-widest text-slate-400 dark:text-slate-500 mb-4 transition-colors">Search Results</h3>

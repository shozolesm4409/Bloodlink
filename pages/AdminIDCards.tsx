...
export const IDCardFrame = React.forwardRef<HTMLDivElement, { user: User }>(({ user }, ref) => {
  ...
  return (
    ...
    >
      <div className="h-[250px] bg-[#001f3f] relative flex flex-col items-center pt-8 overflow-hidden">
      ...
      <div className="flex-1 bg-white px-7 pt-4 flex flex-col items-center relative">
      ...
      <div className="h-[100px] relative overflow-hidden bg-white flex items-end">
